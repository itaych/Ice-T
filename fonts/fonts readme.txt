...
vtibm.fnt - characters 128-255 as found on a standard IBM-PC compatible - needed for ANSI-BBS, which used many of the
		graphics characters.
...
(The vtheb2d.fnt file was built into the final shipping version. No one complained.)
